    ...
    <div className="min-h-screen bg-[#0F1117] text-white">
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          <div className="text-2xl font-bold">Studio Eleven</div>
          <Button 
            variant="ghost" 
      ...
      <section className="container mx-auto px-4 py-24 border-t border-white/10">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="bg-white/5 border-white/10 p-8 rounded-2xl">
            ...
            <h3 className="text-xl font-semibold mb-4">3-Day Turnaround</h3>
            <p className="text-gray-400">
      ...
      <section className="container mx-auto px-4 py-32">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-8">Ready to Transform Your Idea?</h2>
          <p className="text-xl text-gray-400 mb-12">
